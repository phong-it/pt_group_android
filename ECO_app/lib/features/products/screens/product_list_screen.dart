...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          Colors.grey[100], // Nền xám nhạt để làm nổi bật các Card trắng
      appBar: AppBar(
          ...
          Expanded(
            child: RefreshIndicator(
              ...
              child: StreamBuilder<List<ProductModel>>(
                ...
                stream: context.watch<ProductProvider>().getFilteredProducts(
                  _selectedCategory,
                ),
  ...
  Widget _buildEmptyState({bool isSearch = false}) {
    return SingleChildScrollView(
      physics:
          const AlwaysScrollableScrollPhysics(), // Giữ cho vẫn có thể vuốt để refresh
      child: Container(
        height: 400,
                  ...
                  ClipRRect(
                    ...
                    child: SizedBox(
                      ...
                      child: product.imageUrls.isNotEmpty
                          ? CachedNetworkImage(
                              // Dùng thư viện load ảnh siêu mượt
