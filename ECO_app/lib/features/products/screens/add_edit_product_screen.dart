...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          widget.existingProduct != null ? 'Sửa thông tin' : 'Đăng bán món đồ',
        ...
        child: Column(
          ...
          children: [
            ...
            _buildModernInput(
              ...
              hint: 'Vd: Laptop Dell Inspiron cũ',
            ),
  ...
  Future<void> _submitForm(
    ...
    if (user != null && user.role.toLowerCase() == 'buyer') {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Không có quyền hạn đăng bán hãy nâng cấp quyền.'),
    ...
    if (_nameController.text.isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Vui lòng nhập đủ thông tin và chọn lại ảnh!'),
          backgroundColor: Colors.red,
        ),
      );
      return;
    ...
    if (_selectedLocation == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Vui lòng ghim vị trí bán hàng!'),
          backgroundColor: Colors.red,
        ),
      );
      return;
